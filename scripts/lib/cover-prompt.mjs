...
const SUBJECT_HINTS = {
  ...
  "唐太宗": "a Tang dynasty emperor in yellow dragon robe with crown, receiving ministers, palace interior",
  "成吉思汗": "a Mongol warrior-emperor on horseback, fur hat, vast steppe background",
  ...
  "京杭大运河": "grand canal with merchant boats, ancient docks, waterway through cities",
  ...
  "嵩岳寺塔": "ancient brick pagoda with twelve-sided base, misty mountains, Buddhist temple atmosphere",
  ...
  "早发白帝城": "a small boat leaving Baidi city in morning mist, swift river through Three Gorges, monkeys calling on banks, Li Bai standing on bow",
  ...
  "红楼梦": "Jia family garden in spring, Lin Daiyu picking fallen flowers, pavilions and willows",
  "西游记": "Sun Wukong the Monkey King with golden staff, somersault cloud, journey to west",
  "三国演义": "three kingdoms battle scene, Liu Bei Guan Yu Zhang Fei on horseback, banners",
  "水浒传": "108 outlaws at Liangshan marsh, Song Jiang receiving heroes, mountain fortress",
  "聊斋志异": "a fox spirit in white silk emerging from moonlit forest, scholar encountering her",
  "封神演义": "Jiang Ziya with fishing rod by river, King Zhou's decadent palace in background",
  ...
  "唐三彩": "Tang dynasty three-color glazed ceramic horse, ornate saddle, ancient tomb atmosphere",
  "汉服": "Chinese traditional Han dynasty clothing, wide sleeves crossed collar flowing silk robes, wooden hairpin",
