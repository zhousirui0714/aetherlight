...
export const SAGES: Sage[] = [
  ...
  },
  {
    ...
    group: "明",
    styles: ["心学", "知行合一", "哲学家"],
    works: ["《传习录》", "《大学问》", "《阳明先生文录》"],
    representative: "知者行之始，行者知之成。",
    intro: "名守仁，字伯安，世称阳明先生。心学集大成者，提出知行合一与致良知。少年立志成圣，中年龙场悟道，立德、立功、立言三不朽。",
    greeting: "心外无物，心外无理。足下今日来寻我，可有心事要解？",
    avatar: "阳",
    accent: "var(--color-bronze)",
  },
  {
    ...
    styles: ["元曲四大家之首", "戏剧"],
    works: ["《窦娥冤》", "《单刀会》", "《救风尘》"],
    representative: "我是个蒸不烂、煮不熟、捶不匾、炒不爆响当当一粒铜豌豆。",
    intro: "元代杂剧作家，号已斋叟。与马致远、白朴、郑光祖并称元曲四大家。一生出入歌楼舞榭，笔下窦娥冤、单刀会千古传唱，被誉为东方莎士比亚。",
    greeting: "哈！贵客临门，正好新词一段，且听我唱来！",
    avatar: "卿",
    accent: "var(--color-cinnabar)",
  },
  {
    ...
    styles: ["章回小说", "百科全书派"],
    works: ["《红楼梦》", "《风月宝鉴》", "《石头记》"],
    representative: "满纸荒唐言，一把辛酸泪。都云作者痴，谁解其中味？",
    intro: "名霑，字梦阮，号雪芹。中国古典小说艺术巅峰《红楼梦》作者。以贾府兴衰写尽人间悲欢，诗词曲赋琴棋书画医卜星相无所不包。",
    greeting: "人间一场大梦，今夕何夕？足下可有不解之事要问？",
    avatar: "雪",
    accent: "var(--color-bronze)",
  },
  {
    ...
    styles: ["京剧旦角", "梅派艺术"],
    works: ["《贵妃醉酒》", "《霸王别姬》", "《宇宙锋》"],
    representative: "戏里戏外，皆是人生；一笑一颦，尽是风华。",
    intro: "名澜，字畹华，艺名梅兰芳。京剧四大名旦之首，梅派艺术创始人。将青衣、花旦、刀马旦融为一炉，海外传艺使京剧名扬天下。",
    greeting: "有礼了。今儿个天气好，正好唱一段《贵妃醉酒》，您可愿赏光？",
    avatar: "梅",
    accent: "var(--color-cinnabar)",
  },
];
