...
export const persons: Record<string, Person> = {
  "毛亨": {
    name: "毛亨",
    dynasty: "汉代",
    description: "毛亨，生卒年不详，是西汉时期的学者，相传是古文诗学\"毛诗学\"的开创者。他与毛苌一起被称为\"大小毛公\"。他整理并注释《诗经》，形成《毛诗故训传》，对《诗经》的传承和研究影响深远。",
    achievements: [
      "整理并注释《诗经》，形成《毛诗故训传》",
      "开创古文诗学流派",
      "对《诗经》的传承和研究影响深远"
  ...
  "毛苌": {
    name: "毛苌",
    dynasty: "汉代",
    description: "毛苌，西汉著名学者，师从毛亨，继承并传播\"毛诗学\"，世称\"小毛公\"。他曾在河间国（今河北献县）教授《诗经》，使毛诗学得以流传后世。",
    achievements: [
      "继承传播毛诗学",
      "教授《诗经》于河间",
      "与毛亨并称\"大小毛公\""
  ...
  "李白": {
    ...
    birthYear: "701年",
    deathYear: "762年",
    description: "李白，字太白，号青莲居士，又号\"谪仙人\"，唐代伟大的浪漫主义诗人，被后人誉为\"诗仙\"。他出生于碎叶（今吉尔吉斯斯坦），幼年随家人迁居四川绵竹。他的诗想象奇特，感情豪迈，充满浪漫主义色彩。",
    achievements: [
      "创作大量优秀诗篇，风格豪放飘逸",
      "开创浪漫主义诗歌高峰",
      "与杜甫并称\"李杜\"，代表唐诗最高成就",
  ...
  "杜甫": {
    ...
    birthYear: "712年",
    deathYear: "770年",
    description: "杜甫，字子美，号少陵野老，唐代伟大的现实主义诗人。他忧国忧民，诗作深刻反映社会现实，被称为\"诗圣\"。他的诗作风格沉郁顿挫，与李白并称\"李杜\"。",
    achievements: [
      "开创现实主义诗歌传统",
      "被誉为\"诗圣\"",
      "与李白并称\"李杜\"",
  ...
  "白居易": {
    ...
    birthYear: "772年",
    deathYear: "846年",
    description: "白居易，字乐天，号香山居士，唐代伟大的现实主义诗人。他提出\"文章合为时而著，歌诗合为事而作\"的主张，诗作通俗易懂，老妪能解。",
    achievements: [
      "倡导新乐府运动",
      "诗作通俗易懂，流传广泛",
      "与元稹并称\"元白\"",
  ...
  "王维": {
    ...
    birthYear: "701年",
    deathYear: "761年",
    description: "王维，字摩诘，号摩诘居士，唐代著名诗人、画家。他精通诗、书、画、音乐，苏轼评价\"味摩诘之诗，诗中有画；观摩诘之画，画中有诗\"，被尊为\"诗佛\"。",
    achievements: [
      "开创山水诗派",
      "诗中有画，画中有诗",
      "被尊为\"诗佛\"",
  ...
  "陶渊明": {
    ...
    birthYear: "365年",
    deathYear: "427年",
    description: "陶渊明，字元亮，号五柳先生，东晋著名诗人。他不满官场黑暗，辞官归隐，开创田园诗派，被尊为\"田园诗祖\"。他的\"桃花源\"理想影响深远。",
    achievements: [
      "开创田园诗派",
      "被尊为\"田园诗祖\"",
      "提出\"桃花源\"理想",
  ...
  "屈原": {
    ...
    birthYear: "公元前340年",
    deathYear: "公元前278年",
    description: "屈原，名平，字原，楚国诗人、政治家。他忧国忧民，创立的\"楚辞\"体开辟了诗歌新天地，被誉为\"中华诗祖\"。端午节即源于纪念他。",
    achievements: [
      "创立\"楚辞\"体",
      "被誉为\"中华诗祖\"",
      "《离骚》成为中国文学瑰宝",
  ...
  "孔子": {
    ...
    birthYear: "公元前551年",
    deathYear: "公元前479年",
    description: "孔子，名丘，字仲尼，春秋时期鲁国陬邑人，儒家学派创始人，被尊为\"至圣先师\"。他整理六经，开创私学，提倡仁义礼智，对中国传统文化产生深远影响。",
    achievements: [
      "创立儒家学派",
      "整理六经：《诗》《书》《礼》《易》《乐》《春秋》",
      "开创私学，有弟子三千",
  ...
  "庄子": {
    ...
    birthYear: "公元前369年",
    deathYear: "公元前286年",
    description: "庄子，名周，战国时期道家学派的代表人物，与老子并称\"老庄\"。他的哲学思想追求精神自由，文章想象奇特，汪洋恣肆。",
    achievements: [
      "发展道家学派思想",
      "与老子并称\"老庄\"",
      "追求精神自由",
  ...
  "孟子": {
    ...
    birthYear: "公元前372年",
    deathYear: "公元前289年",
    description: "孟子，名轲，字子舆，战国时期儒家学派代表人物，被尊为\"亚圣\"。他继承并发展孔子思想，提出\"性善论\"和\"民本\"思想。",
    achievements: [
      "继承发展孔子思想",
      "被尊为\"亚圣\"",
      "提出\"性善论\"",
  ...
  "荀子": {
    ...
    birthYear: "公元前313年",
    deathYear: "公元前238年",
    description: "荀子，名况，字卿，战国时期儒家学派代表人物。他提出\"性恶论\"，主张礼法兼治，培养了韩非、李斯等法家人物。",
    achievements: [
      "提出\"性恶论\"",
      "主张礼法兼治",
      "培养韩非、李斯等法家人物",
  ...
  "韩愈": {
    ...
    birthYear: "768年",
    deathYear: "824年",
    description: "韩愈，字退之，唐代文学家、思想家，唐宋八大家之首。他倡导古文运动，提出\"文以载道\"主张，被尊为\"百代文宗\"。",
    achievements: [
      "倡导古文运动",
      "被尊为\"百代文宗\"",
      "唐宋八大家之首",
  ...
  "李清照": {
    ...
    birthYear: "1084年",
    deathYear: "约1155年",
    description: "李清照，号易安居士，宋代著名女词人。她婉约词派的代表人物，前期词作清新秀丽，后期词作感伤沉郁，被誉为\"千古第一才女\"。",
    achievements: [
      "婉约词派代表人物",
      "被誉为\"千古第一才女\"",
      "提出词\"别是一家\"理论",
  ...
  "辛弃疾": {
    ...
    birthYear: "1140年",
    deathYear: "1207年",
    description: "辛弃疾，字幼安，号稼轩，南宋豪放派词人。他一生以恢复中原为志，词作慷慨激昂，充满爱国热情，与苏轼并称\"苏辛\"。",
    achievements: [
      "豪放派词人代表",
      "与苏轼并称\"苏辛\"",
      "词作充满爱国热情",
...
子曰："名不正则言不顺，言不顺则事不成，事不成则礼乐不兴，礼乐不兴则刑罚不中，刑罚不中则民无所措手足。"`,
  ...
  "道德经": {
    ...
    dynasty: "春秋",
    author: "老子",
    summary: "《道德经》又称《老子》，是道家学派的经典著作，共八十一章。它以\"道\"为核心，阐述宇宙本源、政治哲学、人生修养等思想，对中国乃至世界哲学产生了深远影响。",
...
知我者，谓我心忧；不知我者，谓我何求。悠悠苍天，此何人哉？`,
    chapters: ["国风（周南、召南、邶、鄘、卫、王、郑、齐、魏、唐、秦、陈、桧、曹、豳）", "小雅", "大雅", "颂（周颂、鲁颂、商颂）"]
  },
  "将进酒": {
    title: "将进酒",
    dynasty: "唐代",
...
小知不及大知，小年不及大年。奚以知其然也？朝菌不知晦朔，蟪蛄不知春秋，此小年也。楚之南有冥灵者，以五百岁为春，五百岁为秋；上古有大椿者，以八千岁为春，八千岁为秋，此大年也。而彭祖乃今以久特闻，众人匹之，不亦悲乎！`,
  ...
  "孟子": {
    ...
    dynasty: "战国",
    author: "孟子",
    summary: "《孟子》是记录孟子言行的儒家经典，共七篇十四卷。它系统阐述了孟子的\"性善论\"、\"民本思想\"和\"仁政\"主张，是儒家学说的重要著作。",
    content: `第一章：梁惠王章句上
...
满地黄花堆积，憔悴损，如今有谁堪摘？守着窗儿，独自怎生得黑！梧桐更兼细雨，到黄昏、点点滴滴。这次第，怎一个愁字了得！`,
  ...
  "春江花月夜": {
    ...
    dynasty: "唐代",
    author: "张若虚",
    summary: "《春江花月夜》是唐代诗人张若虚的代表作，被闻一多先生誉为\"诗中的诗，顶峰上的顶峰\"。全诗以月为主体，以江为场景，描绘了一幅幽美邈远的春江月夜图。",
...
不知乘月几人归，落月摇情满江树。`,
  ...
  "爱莲说": {
    ...
    dynasty: "宋代",
    author: "周敦颐",
    summary: "《爱莲说》是宋代周敦颐的代表作，通过赞美莲花\"出淤泥而不染\"的品质，表达作者洁身自好的高尚情操。",
...
予谓菊，花之隐逸者也；牡丹，花之富贵者也；莲，花之君子者也。噫！菊之爱，陶后鲜有闻。莲之爱，同予者何人？牡丹之爱，宜乎众矣！`,
  ...
  "岳阳楼记": {
    ...
    dynasty: "宋代",
    author: "范仲淹",
    summary: "《岳阳楼记》是宋代范仲淹的代表作，通过描写岳阳楼景色，表达了\"先天下之忧而忧，后天下之乐而乐\"的伟大政治抱负。",
...
export const culturalKnowledge: Record<string, KnowledgeEntry> = {
  "李白喝酒": {
    ...
    quotes: [
      ...
      {
        text: "花间一壶酒，独酌无相亲。举杯邀明月，对影成三人。月既不解饮，影徒随我身。暂伴月将影，行乐须及春。",
        title: "月下独酌",
        author: "李白",
        dynasty: "唐"
      },
      {
        text: "抽刀断水水更流，举杯消愁愁更愁。人生在世不称意，明朝散发弄扁舟。",
        title: "宣州谢朓楼饯别校书叔云",
        author: "李白",
        dynasty: "唐"
      },
  ...
  "中秋赏月": {
    ...
    scholarAnalysis: "历史学家杨宽认为，中秋节起源于上古的秋分祭月，经过唐宋时期的发展，逐渐从宗教祭祀演变为民间的团圆节日。\n\n民俗学家乌丙安指出，中秋赏月习俗的形成与农业生产周期密切相关，八月十五正值秋收时节，人们在丰收之余举行祭月、赏月活动，表达对天地自然的感恩之情。",
    graphNodes: [
  ...
  "诗经风雅颂": {
    ...
    answer: "《诗经》是中国最早的诗歌总集，分为风、雅、颂三部分。'风'是各地民歌，共十五国风160篇；'雅'是宫廷乐歌，分大雅小雅共105篇；'颂'是宗庙祭祀乐歌，共40篇。三者合称'诗之六义'。",
    quotes: [
      {
    ...
    scholarAnalysis: "文学史家游国恩指出，风雅颂的划分不仅是音乐上的区别，更反映了社会阶层和用途的差异，是研究周代社会的重要史料。\n\n经学家朱熹在《诗集传》中认为，'风'是民俗歌谣之诗，'雅'是正乐之诗，'颂'是宗庙祭祀之诗。\n\n现代学者袁行霈则认为，《诗经》的风雅颂体现了中国古代诗学的'美刺'传统，即诗歌具有讽喻和赞美的社会功能。",
    graphNodes: [
  ...
  "苏轼代表作": {
    ...
    quotes: [
      ...
      {
        text: "寄蜉蝣于天地，渺沧海之一粟。哀吾生之须臾，羡长江之无穷。",
        title: "前赤壁赋",
        author: "苏轼",
        dynasty: "宋"
      },
    ...
    scholarAnalysis: "词学家唐圭璋认为，苏轼开创了豪放词派，将词从'艳科'提升到可以抒写人生哲理和家国情怀的高度，对后世词坛影响深远。\n\n文学史家钱钟书指出，苏轼是宋代最有多方面才能的文学家，他的散文与韩愈、柳宗元并称'唐宋八大家'，诗歌与黄庭坚并称'苏黄'，词与辛弃疾并称'苏辛'，书法与黄庭坚、米芾、蔡襄并称'宋四家'。",
    graphNodes: [
  ...
  "孔子思想": {
    ...
    question: "孔子的核心思想是什么？",
    answer: "孔子的核心思想是'仁'和'礼'。'仁'是爱人，是道德修养的最高境界；'礼'是社会秩序和行为规范。他主张通过修身、齐家、治国、平天下来实现社会和谐。孔子被尊为'至圣先师'，对中国文化产生了深远影响。",
    quotes: [
      {
        text: "仁者爱人。",
        title: "论语·颜渊",
    ...
    interpretations: "孔子的思想强调道德修养和社会责任，主张通过教育和自我完善来实现个人价值和社会和谐。他提出'有教无类'的教育思想，打破了贵族对教育的垄断。孔子的思想对中国传统文化产生了深远影响，成为中国文化的核心价值体系。",
    scholarAnalysis: "哲学家冯友兰认为，孔子的'仁'学是一种道德理想主义，强调通过内在的道德自觉来达到外在的社会秩序，是中国传统文化的核心精神。\n\n历史学家李学勤指出，孔子创立的儒家学说成为中国传统文化的主干，其'仁政'思想对后世的政治哲学产生了深远影响。\n\n教育学家陶行知认为，孔子'有教无类'的教育思想打破了阶级壁垒，为后世普及教育奠定了思想基础。",
    graphNodes: [
  ...
  "道德经": {
    ...
    answer: "《道德经》是道家学派的经典著作，核心思想是'道'。道是宇宙的本源和规律，主张顺应自然、无为而治，追求内心的宁静和精神的自由。全书五千余字，分为道经和德经两部分。",
    quotes: [
      {
    ...
    interpretations: "《道德经》倡导一种自然无为的生活态度，认为顺应自然规律才能达到真正的自由和和谐。它提出的'道法自然'、'无为而治'、'上善若水'等思想成为中国哲学的重要源头，影响了后世无数哲学家和政治家的思想。",
    scholarAnalysis: "哲学家陈鼓应认为，老子的'道'不仅是宇宙的本源，也是一种生活智慧，教导人们以柔克刚、以静制动，在纷繁的世界中保持内心的宁静。\n\n历史学家钱穆指出，《道德经》是世界上除《圣经》以外被翻译最多的典籍，对世界哲学产生了深远影响。\n\n道教学者任继愈认为，老子思想的核心是'道'，而'道'的本质是'自然'，即顺应事物本来的规律。",
    graphNodes: [
  ...
  "屈原离骚": {
    id: "qu-yuan-li-sao",
    question: "屈原与《离骚》",
    answer: "屈原，名平，字原，战国时期楚国诗人、政治家。他忧国忧民，创立的'楚辞'体开辟了诗歌新天地，被誉为'中华诗祖'。《离骚》是其代表作，是中国古代最长的抒情诗。",
    quotes: [
      {
        text: "帝高阳之苗裔兮，朕皇考曰伯庸。",
        title: "离骚",
    ...
    scholarAnalysis: "文学史家鲁迅称《离骚》'逸响伟辞，卓绝一世'，给予了极高评价。\n\n楚辞研究专家姜亮夫认为，屈原的创作将中国诗歌从集体歌唱推进到个人独创的新阶段，开创了中国文学的浪漫主义传统。",
    graphNodes: [
  ...
  "桃花源记": {
    ...
    interpretations: "《桃花源记》通过描写一个与世隔绝的理想社会，表达了陶渊明对黑暗现实的不满和对美好生活的向往。'桃花源'成为后世文人追求的理想世界的代名词。",
    scholarAnalysis: "文学史家萧统编纂《陶渊明集》，给予陶渊明极高评价。\n\n学者陈寅恪认为，桃花源故事反映了魏晋时期战乱频仍背景下人们对安宁生活的渴望，同时也体现了道家'小国寡民'的思想影响。",
    graphNodes: [
  ...
  "唐诗宋词": {
    ...
    scholarAnalysis: "文学史家钱钟书在《谈艺录》中指出，唐诗以情韵胜，宋词以意趣胜，各有所长。\n\n学者王国维在《人间词话》中提出，'词以境界为最上'，对唐宋词的艺术成就进行了深入分析。",
    graphNodes: [
