...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "溯历史长河,撷文明之光。一个用 AI 激活传统文化的互动平台。 以大语言模型为核心引擎，集每日文化推送、知识百科、跨越时空的「与名家对话」、AI 艺术创作、聊天社区与传统知识答题为一体，让传统文化在数字时代「活起来」。" },
      { property: "og:title", content: "溯光Aetherlight · 活化中国传统文化" },
      { property: "og:description", content: "溯历史长河,撷文明之光。一个用 AI 激活传统文化的互动平台。 以大语言模型为核心引擎，集每日文化推送、知识百科、跨越时空的「与名家对话」、AI 艺术创作、聊天社区与传统知识答题为一体，让传统文化在数字时代「活起来」。" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "溯光Aetherlight · 活化中国传统文化" },
      { name: "twitter:description", content: "溯历史长河,撷文明之光。一个用 AI 激活传统文化的互动平台。 以大语言模型为核心引擎，集每日文化推送、知识百科、跨越时空的「与名家对话」、AI 艺术创作、聊天社区与传统知识答题为一体，让传统文化在数字时代「活起来」。" },
